	...
	private static final String GO_NAME = "GO";
	 ...
	 private ArrayList<Square> squares;
	  ...
	  private static final String GOTO_JAIL_NAME = "Go To Jail";
			  ...
			  private static final String[] TAX_NAMES = {"Income Tax", "Super Tax"};
		      private static final int[] TAX_AMOUNTS = {200,100};
		...
		squares = new ArrayList<Square>();	
		 ...
		 for(i=0; i<SQUARE_TYPES.length ; i++){
			...
			case 3:
				...
				break;
			case 4:
				squares.add(new CommunityChest(COMMUNITY_NAME, SQUARE_TYPES[i]));
				break;
			case 5:
			...
			case 8:
				...
				break;
			case 9:
				 squares.add(new Tax(TAX_NAMES[d], SQUARE_TYPES[i], TAX_AMOUNTS[d]));
	             d++;
				break;	 
